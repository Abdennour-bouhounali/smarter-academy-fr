 ...
 */
const EPREUVES = [
  { id: 'tc-e1', skill: 'variables', title: 'Variable qualitative', prompt: 'Laquelle de ces variables est qualitative ?', options: ['Le sport pratiqué', 'La taille en centimètres', 'Le nombre de frères et sœurs', 'La durée d’un trajet'], cols: 2, explain: 'Une variable qualitative prend pour valeurs des modalités (des mots), pas des nombres sur lesquels on calcule.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_tableaux-croises-2nde_P1'] } },
  { id: 'tc-e2', skill: 'variables', title: 'Nominale', prompt: 'Une variable qualitative NOMINALE est une variable dont les modalités…', options: ['n’ont pas d’ordre naturel', 'sont toujours au nombre de deux', 'sont des nombres', 'peuvent être moyennées'], cols: 2, explain: 'Nominale = sans ordre (couleur des yeux, sport). Ordinale = avec un ordre naturel (niveau, mention).', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_tableaux-croises-2nde_P2'] } },
  { id: 'tc-e3', skill: 'variables', title: 'Ordinale', prompt: 'Laquelle de ces variables est ORDINALE ?', options: ['La mention au bac (passable, AB, B, TB)', 'La ville de naissance', 'La couleur préférée', 'Le prénom'], cols: 2, explain: 'Les mentions se rangent naturellement de la plus faible à la plus forte ; les trois autres n’ont aucun ordre intrinsèque.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_tableaux-croises-2nde_P3'] } },
  { id: 'tc-e4', skill: 'construire', title: 'Un fichier de données', prompt: 'Dans un fichier de données individuelles, une LIGNE représente…', options: ['un individu, décrit par toutes ses variables', 'une variable, pour tous les individus', 'un effectif', 'une modalité'], cols: 2, explain: 'Une ligne = un individu, une colonne = une variable. C’est ce qui permet ensuite de compter les croisements.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_tableaux-croises-2nde_P4'] } },
  { id: 'tc-e5', skill: 'construire', title: 'Case ou marge ?', prompt: 'Un tableau croise « sport » et « classe ». Où lit-on le nombre d’élèves de 2de B qui font du judo ?', options: ['Dans la case croisant la ligne judo et la colonne 2de B', 'Dans le total de la ligne judo', 'Dans le total de la colonne 2de B', 'Dans le total général'], cols: 1, explain: 'Une case croise les DEUX caractères ; les marges ne renseignent que sur un seul.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_tableaux-croises-2nde_P6', 'seconde_tableaux-croises-2nde_P7'] } },
  { id: 'tc-e6', skill: 'marges', title: 'Effectif marginal', prompt: 'Une ligne d’un tableau croisé contient 6, 3 et 6. Que vaut son effectif marginal ?', options: ['15', '6', '3', '60'], cols: 4, explain: '6 + 3 + 6 = 15 : l’effectif marginal d’une ligne est la somme de ses cases, toutes colonnes confondues.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_tableaux-croises-2nde_P8'] } },
  { id: 'tc-e7', skill: 'marges', title: 'La double somme', prompt: 'Dans un tableau croisé correct, la somme des totaux de lignes et la somme des totaux de colonnes…', options: ['sont toutes deux égales à l’effectif total', 'sont en général différentes', 's’additionnent pour donner l’effectif total', 'ne se comparent pas'], cols: 1, explain: 'Chaque individu est compté une fois dans sa ligne et une fois dans sa colonne : les deux sommes valent l’effectif total. C’est une vérification gratuite du comptage.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_tableaux-croises-2nde_P8', 'seconde_tableaux-croises-2nde_P7'] } },
  { id: 'tc-e8', skill: 'filtrer', title: 'Le OU inclusif', prompt: 'Sur 60 élèves : 20 en 2de B, 19 danseurs, dont 6 en 2de B qui dansent. Combien sont « en 2de B OU danseurs » ?', options: ['33', '39', '6', '45'], cols: 4, explain: '20 + 19 − 6 = 33. Les 6 élèves vérifiant les deux critères seraient comptés deux fois par la simple addition 39.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_tableaux-croises-2nde_P10', 'seconde_tableaux-croises-2nde_P5'] } },
  { id: 'tc-e9', skill: 'filtrer', title: 'Le NON', prompt: 'Sur 60 élèves, 26 sont en 2de C. Combien ne sont PAS en 2de C ?', options: ['34', '26', '60', '86'], cols: 4, explain: '60 − 26 = 34 : le NON désigne le complémentaire dans la population totale.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_tableaux-croises-2nde_P10'] } },
  { id: 'tc-e10', skill: 'interpreter', title: 'Comparer honnêtement', prompt: 'La 2de A (14 élèves) compte 5 danseurs, la 2de C (26 élèves) en compte 8. Que conclure ?', options: [
