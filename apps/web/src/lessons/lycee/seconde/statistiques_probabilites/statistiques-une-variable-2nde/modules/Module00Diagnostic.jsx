...
const QUESTIONS = [
  ...
  { id: 'st-d7', skill: 'resumer', points: 2, requires: ['indicateur-stat', 'etendue', 'dispersion', 'mode-stat'], prompt: 'Série : 4, 7, 7, 7, 12. Parmi ces indicateurs, lequel mesure la dispersion (l’étalement) et non la position ?', options: ['L’étendue : 12 − 4 = 8', 'Le mode : 7', 'La moyenne : 7,4'], cols: 1, correct: 0, explain: 'Le mode (la valeur la plus fréquente) et la moyenne disent OÙ se situe la série ; l’étendue, écart entre la plus grande et la plus petite valeur, dit sur quelle largeur elle s’étale.' },
