 ...
 */
const EPREUVES = [
  { id: 'sr-e1', skill: 'regrouper', title: 'Pourquoi regrouper', prompt: 'On mesure au centième de seconde le temps de 300 coureurs. Pourquoi regrouper en classes ?', options: ['Parce que les valeurs sont presque toutes distinctes : un tableau d’effectifs classique n’apprendrait rien', 'Parce que le calcul de la moyenne devient exact', 'Parce que c’est obligatoire au-delà de 100 données', 'Parce que cela supprime les valeurs extrêmes'], cols: 1, explain: 'Sur une variable continue mesurée finement, chaque valeur a un effectif de 1. Regrouper rend la distribution lisible — mais rend les indicateurs approchés, pas exacts.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_series-regroupees-classes-2nde_P1'] } },
  { id: 'sr-e2', skill: 'regrouper', title: 'Amplitude', prompt: 'Une série s’étend de 10 à 90 et l’on veut 8 classes de même amplitude. Quelle amplitude ?', options: ['10', '8', '80', '11,25'], cols: 4, explain: '(90 − 10) ÷ 8 = 10. L’étendue vaut 80, le nombre de classes 8.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_series-regroupees-classes-2nde_P2'] } },
  { id: 'sr-e3', skill: 'histogramme', title: 'La hauteur des barres', prompt: 'Dans un histogramme dont les classes ont des amplitudes INÉGALES, que représente la hauteur d’une barre ?', options: ['L’effectif divisé par l’amplitude — c’est l’AIRE qui donne l’effectif', 'L’effectif de la classe', 'La fréquence de la classe', 'Le centre de la classe'], cols: 1, explain: 'C’est l’aire qui porte l’effectif. Une classe deux fois plus large et de même effectif est deux fois plus basse.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_series-regroupees-classes-2nde_P3'] } },
  { id: 'sr-e4', skill: 'histogramme', title: 'Lire un histogramme', prompt: 'Classes [0;10[ : 12 ; [10;20[ : 30 ; [20;30[ : 45 ; [30;40] : 13. Combien d’individus en dessous de 20 ?', options: ['42', '30', '87', '12'], cols: 4, explain: '12 + 30 = 42. On additionne les effectifs de toutes les classes situées avant 20 ; 30 n’est que celui de la seconde classe.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_series-regroupees-classes-2nde_P4'] } },
  { id: 'sr-e5', skill: 'cumul', title: 'Fréquences cumulées', prompt: 'Avec ces mêmes classes (total 100), quelle est la fréquence cumulée croissante à 30 ?', options: ['87 %', '45 %', '13 %', '100 %'], cols: 4, explain: '(12 + 30 + 45) ÷ 100 = 87 %. Le cumul à 30 compte tout ce qui est en dessous de 30.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_series-regroupees-classes-2nde_P5'] } },
  { id: 'sr-e6', skill: 'moyenne', title: 'Moyenne pondérée', prompt: 'Trois classes de centres 5, 15 et 25, d’effectifs 5, 15 et 10. Moyenne estimée ?', options: ['16,67', '15', '45', '30'], cols: 4, explain: '(5×5 + 15×15 + 10×25) ÷ 30 = 500 ÷ 30 ≈ 16,67. Faire (5 + 15 + 25) ÷ 3 = 15 revient à ignorer les effectifs.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_series-regroupees-classes-2nde_P6', 'seconde_series-regroupees-classes-2nde_P7'] } },
  { id: 'sr-e7', skill: 'moyenne', title: 'Estimation ou exact ?', prompt: 'La moyenne calculée à partir des centres de classes est…', options: ['une estimation, car la répartition à l’intérieur de chaque classe est inconnue', 'exacte, car tous les individus sont comptés', 'toujours supérieure à la moyenne réelle', 'exacte si les classes ont la même amplitude'], cols: 1, explain: 'Remplacer chaque individu par le centre de sa classe est une hypothèse. L’écart peut aller dans les deux sens, et l’égalité des amplitudes n’y change rien.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_series-regroupees-classes-2nde_P7'] } },
  { id: 'sr-e8', skill: 'mediane', title: 'La classe médiane', prompt: 'Fréquences cumulées : [0;10[ 12 % ; [10;20[ 42 % ; [20;30[ 87 % ; [30;40] 100 %. Quelle est la classe médiane ?', options: ['[20 ; 30[', '[10 ; 20[', '[30 ; 40]', '[0 ; 10['], cols: 4, explain: 'C’est la première classe dont la fréquence cumulée atteint 50 % : à 20 le cumul vaut 42 % (insuffisant), il passe à 87 % dans [20 ; 30[.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_series-regroupees-classes-2nde_P8'] } },
  { id: 'sr-e9', skill: 'mediane', title: 'Estimer la médiane', prompt: 'Classe médiane [20 ; 30[, cumul 42 individus avant elle, 45 dedans, total 100. Médiane estimée par interpolation ?', options: ['≈ 21,8', '25', '20', '30'], cols: 4, explain: '20 + ((50 − 42)/45) × 10 ≈ 21,8. Prendre 25 reviendrait à confondre la médiane avec le CENTRE de sa classe, ce qui n’est vrai que par hasard.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_series-regroupees-classes-2nde_P9'] } },
  { id: 'sr-e10', skill: 'interpreter', title: 'Ce que la série ne dit plus', prompt: 'À partir d’un tableau regroupé seul, laquelle de ces affirmations est légitime ?', options: ['« 42 % des individus sont en dessous de 20 »', '« La valeur la plus fréquente est 17 »', '« Aucun individu ne vaut exactement 25 »', '« La médiane vaut exactement 21,83 »'], cols: 1, explain: 'Un cumul de classes est exact. En revanche, tout ce qui descend sous la classe — valeur la plus fréquente, existence d’une valeur, médiane au centième — est perdu par le regroupement.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_series-regroupees-classes-2nde_P10'] } },
];
const SKILLS = {
