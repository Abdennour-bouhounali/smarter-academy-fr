...
const EPREUVES = [
  ...
  { id: 'ev-e5', skill: 'global', requires: ['coefficient-global', 'methode-composer', 'somme-jamais', 'arrondi'], title: 'Trois évolutions', prompt: 'Un abonnement subit +50 %, puis +40 %, puis −20 %. Le coefficient global vaut…', options: ['1,68', '1,70', '1,90', '0,68'], cols: 4, explain: '1,50 × 1,40 × 0,80 = 1,68, soit +68 %. Additionner les taux donnerait 50 + 40 − 20 = +70 %, donc 1,70 : c’est FAUX, et l’écart se voit. Les coefficients se multiplient, les taux ne s’additionnent jamais.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_evolutions-successives-reciproques-2nde_P2', 'seconde_evolutions-successives-reciproques-2nde_P3'] } },
