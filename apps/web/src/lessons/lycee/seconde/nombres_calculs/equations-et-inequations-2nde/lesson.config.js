...
export const LESSON_CONFIG = {
  ...
  modules: [
    ...
    { id: '05', number: 5, slug: 'quotient-et-valeur-interdite', path: `${LESSON_BASE_PATH}/quotient-et-valeur-interdite`, title: 'Quotient et valeur interdite', desc: 'Un trou dans la courbe : la valeur qui annule le dénominateur est interdite. À retenir, pour tous les types.', stage: 'formalization', teachesLearningPointIds: ['seconde_equations-et-inequations-2nde_P6', 'seconde_equations-et-inequations-2nde_P7', 'seconde_equations-et-inequations-2nde_P2', 'seconde_equations-et-inequations-2nde_P5'], color: 'violet', style: 'featured', estimatedMin: 10, difficulty: 3, actionText: 'Trouver le trou' },
    { id: '06', number: 6, slug: 'modeliser', path: `${LESSON_BASE_PATH}/modeliser`, title: 'Modéliser', desc: 'Un rectangle, un budget, une vitesse : traduire, résoudre, vérifier, interpréter.', stage: 'practice_lab', teachesLearningPointIds: ['seconde_equations-et-inequations-2nde_P7', 'seconde_equations-et-inequations-2nde_P2', 'seconde_equations-et-inequations-2nde_P3'], color: 'rose', style: 'featured', estimatedMin: 14, difficulty: 4, actionText: 'Modéliser' },
