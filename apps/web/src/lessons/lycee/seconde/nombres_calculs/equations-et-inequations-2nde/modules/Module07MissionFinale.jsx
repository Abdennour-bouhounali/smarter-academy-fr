...
const REGISTRE = [
  ...
  { id: 'eq-e11', skill: 'quotient', requires: ['valeur-interdite', 'quotient-nul'], title: 'Épreuve 11', prompt: 'Avant même de résoudre (x − 3)/(x + 1) = 0, quelle valeur doit-on écarter, et pourquoi ?', options: ['x = −1, car elle annule le dénominateur : la division serait impossible', 'x = 3, car elle annule le numérateur', 'x = 0, car on ne divise jamais par une expression', 'Aucune : une fraction est toujours calculable'], cols: 1, correct: 0, explain: 'Le dénominateur x + 1 s’annule en x = −1 : l’expression n’y est pas définie, c’est la valeur interdite — l’ensemble de définition est ℝ privé de −1. On la détermine AVANT de résoudre. Ensuite seulement : le quotient est nul quand le numérateur l’est, donc x = 3, qui est bien autorisé.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_equations-et-inequations-2nde_P8'] } },
  { id: 'eq-e12', skill: 'modeliser', requires: ['methode-modeliser', 'regle-interpreter-solution'], title: 'Épreuve 12', prompt: 'Un vélo se loue 15 € puis 2 € par heure. On dispose de 25 €. Quelle traduction est correcte ?', options: ['15 + 2h ≤ 25, donc au plus 5 heures', '15 + 2h = 25, donc exactement 5 heures', '2 + 15h ≤ 25, donc au plus 1 heure', '15h + 2 ≤ 25, donc au plus 1,5 heure'], cols: 1, correct: 0, explain: 'Le forfait 15 € est payé une fois, les 2 € reviennent à CHAQUE heure : 15 + 2h. « On dispose de 25 € » est un plafond, donc une INÉQUATION (≤), pas une égalité : 2h ≤ 10, h ≤ 5. Confondre le fixe et le variable donne 2 + 15h, qui n’a pas le même sens.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_equations-et-inequations-2nde_P9'] } },
  { id: 'eq-e13', skill: 'sens', requires: ['methode-verifier-solution', 'equation-solution'], title: 'Épreuve 13', prompt: 'Léa résout 2x + 5 = 13 et trouve x = 4. Comment le VÉRIFIE-t-elle ?', options: ['Elle remplace x par 4 dans 2x + 5 et regarde si elle obtient 13', 'Elle refait le calcul dans le même sens', 'Elle vérifie que 4 est plus petit que 13', 'Elle demande à la calculatrice de résoudre'], cols: 1, correct: 0, explain: '2 × 4 + 5 = 13 ✓ : une solution est un nombre qui rend l’égalité VRAIE, donc on le remplace et on compare les deux membres. Refaire le calcul dans le même sens répéterait une éventuelle erreur — la vérification n’a de valeur que si elle emprunte un autre chemin.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_equations-et-inequations-2nde_P10'] } },
];
const SKILLS = {
