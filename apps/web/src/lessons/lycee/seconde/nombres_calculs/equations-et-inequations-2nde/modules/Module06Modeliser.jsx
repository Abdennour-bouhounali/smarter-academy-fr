            ...
            <div className="space-y-3">
              ...
              {d1a && (
                <NumericQuestion prompt="Résous : quelle est la largeur x ?" expected={5} parse={parseDec} display="5" suffix="cm"
                  ...
                  explainFor={(v) => (v === 6.5 ? 'Tu as oublié de développer 2(x + 3) = 2x + 6 : 4x + 6 = 26 → 4x = 20 → x = 5.' : v === 8 ? '8 est la LONGUEUR (x + 3). La largeur x vaut 5.' : v === 10 ? '4x = 20 donne x = 5, pas 10 : on divise par le coefficient 4.' : '4x + 6 = 26 → 4x = 20 → x = 5. Vérifie : 2 × 5 + 2 × 8 = 26.')}
