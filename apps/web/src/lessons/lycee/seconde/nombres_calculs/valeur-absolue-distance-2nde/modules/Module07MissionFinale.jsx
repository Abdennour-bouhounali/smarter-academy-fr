...
/**
 * Module 7 — Boss Final « Le phare » (kit, QCM). DONNÉES.
...
const EPREUVES = [
  { id: 'va-e1', skill: 'distance0', title: 'Épreuve 1', prompt: 'Deux bateaux sont aux kilomètres −6 et 6 ; le phare est au km 0. Lequel est le plus loin du phare ?', options: ['Ils sont à la même distance : 6 km', 'Celui du km −6, car −6 < 6', 'Celui du km 6, car 6 > −6', 'On ne peut pas savoir'], cols: 1, correct: 0, explain: '|−6| = |6| = 6 : un nombre et son opposé sont à la même distance de 0. La distance est une longueur, elle ne regarde pas le sens.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_valeur-absolue-distance-2nde_P1'] } },
  { id: 'va-e2', skill: 'calcul', title: 'Épreuve 2', prompt: 'Combien vaut |−7,5| ?', options: ['7,5', '−7,5', '0', '7'], cols: 4, correct: 0, explain: '|−7,5| est la distance de −7,5 à 0 : 7,5. La règle : x < 0 → |x| = −x = −(−7,5) = 7,5.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_valeur-absolue-distance-2nde_P2', 'seconde_valeur-absolue-distance-2nde_P1'] } },
  { id: 'va-e3', skill: 'calcul', title: 'Épreuve 3', prompt: 'Si x = −4, combien vaut −|x| ?', options: ['−4', '4', '0', '−8'], cols: 4, correct: 0, explain: '|−4| = 4, puis l’opposé : −4. Le signe − devant les barres s’applique APRÈS la valeur absolue.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_valeur-absolue-distance-2nde_P2'] } },
  { id: 'va-e4', skill: 'ecart', title: 'Épreuve 4', prompt: 'Quelle est la distance entre −4 et 6 ?', options: ['10', '2', '−10', '24'], cols: 4, correct: 0, explain: '|6 − (−4)| = |10| = 10. « 6 − 4 = 2 » oublie le signe de −4 ; une distance n’est jamais négative.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_valeur-absolue-distance-2nde_P3'] } },
  { id: 'va-e5', skill: 'ecart', title: 'Épreuve 5', prompt: 'Laquelle de ces expressions donne la distance entre a et b ?', options: ['|a − b|', 'a − b', 'b − a', '|a| − |b|'], cols: 4, correct: 0, explain: '|a − b| = |b − a| est toujours positif et symétrique. a − b peut être négatif ; |a| − |b| compare les distances à 0, pas la distance entre a et b (pour a = −3, b = 3 : 0 au lieu de 6).', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_valeur-absolue-distance-2nde_P3'] } },
  { id: 'va-e6', skill: 'faisceau', title: 'Épreuve 6', prompt: 'Quel est l’ensemble des x tels que |x − 1| ≤ 4 ?', extra: line({ min: -6, max: 8, step: 1, points: [{ id: 'a', value: 1, label: 'a = 1', tone: 'amber' }], ariaLabel: 'Droite de −6 à 8 avec le centre 1' }), options: ['[−3 ; 5]', ']−∞ ; 5]', '[1 ; 5]', ']−3 ; 5['], cols: 2, correct: 0, explain: 'Faisceau centré en 1, rayon 4 : de 1 − 4 = −3 à 1 + 4 = 5, bords inclus (≤). ]−∞ ; 5] oublie le bord gauche, [1 ; 5] un côté entier.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_valeur-absolue-distance-2nde_P5'] } },
  { id: 'va-e7', skill: 'faisceau', title: 'Épreuve 7', prompt: 'Quelle inégalité décrit l’intervalle ]−7 ; −1[ ?', options: ['|x + 4| < 3', '|x − 4| < 3', '|x + 7| < 6', '|x + 4| ≤ 3'], cols: 2, correct: 0, explain: 'Centre = (−7 + (−1)) ÷ 2 = −4, rayon 3, crochets ouverts → strict : |x − (−4)| < 3, soit |x + 4| < 3.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_valeur-absolue-distance-2nde_P5'] } },
  { id: 'va-e8', skill: 'situations', title: 'Épreuve 8', prompt: 'Une pièce doit mesurer 50 mm à 0,2 mm près. Quelles longueurs L sont acceptées ?', options: ['[49,8 ; 50,2]', '[50 ; 50,2]', ']49,8 ; 50,2[', '[49,8 ; 50]'], cols: 2, correct: 0, explain: '|L − 50| ≤ 0,2 : centre 50, rayon 0,2, bords inclus. La tolérance joue des deux côtés.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_valeur-absolue-distance-2nde_P4', 'seconde_valeur-absolue-distance-2nde_P5'] } },
  { id: 'va-e9', skill: 'situations', title: 'Épreuve 9', prompt: 'Un thermostat maintient la température entre 18 °C et 22 °C inclus. Quelle écriture en valeur absolue convient ?', options: ['|T − 20| ≤ 2', '|T − 18| ≤ 22', '|T − 20| < 2', '|T − 2| ≤ 20'], cols: 2, correct: 0, explain: 'Centre 20 (milieu de 18 et 22), rayon 2, bornes incluses : |T − 20| ≤ 2.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_valeur-absolue-distance-2nde_P4'] } },
  { id: 'va-e10', skill: 'situations', title: 'Épreuve 10', prompt: 'Un cycliste est exactement à 5 km de la borne 3. Où peut-il être ?', options: ['À la borne −2 ou à la borne 8', 'À la borne 8 seulement', 'À la borne 5 ou à la borne −5', 'À la borne 2'], cols: 2, correct: 0, explain: '|x − 3| = 5 ⇔ x = 3 − 5 = −2 ou x = 3 + 5 = 8 : deux positions, de part et d’autre de la borne 3.', assessment: { enabled: true, type: 'assessment', learningPointIds: ['seconde_valeur-absolue-distance-2nde_P4'] } },
];
const BADGES = [
...
function Synthese() {
  return (
    <div className="space-y-4">
      <div className="text-center space-y-1"><h2 className="text-xl font-space font-extrabold text-slate-900">Synthèse : le phare</h2><p className="text-sm text-slate-500">Le faisceau |x − 3| ≤ 2, figé, avec ses deux bords.</p></div>
      <div className="rounded-2xl border-2 border-slate-200 bg-white p-2">
        <RealLine min={-4} max={8} step={1} intervals={[{ id: 'beam', from: 1, to: 5, tone: 'amber', label: '[1 ; 5]' }]} points={[{ id: 'a', value: 3, label: 'a = 3', tone: 'amber' }, { id: 'l', value: 1, label: '3 − 2', tone: 'emerald' }, { id: 'r', value: 5, label: '3 + 2', tone: 'emerald' }]} ariaLabel="Faisceau centré en 3 de rayon 2, de 1 à 5" />
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
        <Feedback tone="info"><strong>|x|</strong> = distance de x à 0 ; x et −x ont la même ; |x| = x si x ≥ 0, −x sinon.</Feedback>
        <Feedback tone="info"><strong>|b − a|</strong> = distance entre a et b, quel que soit l’ordre, inchangée par translation.</Feedback>
        <Feedback tone="info"><strong>|x − a| = r</strong> : deux solutions a − r et a + r (une si r = 0, aucune si r &lt; 0).</Feedback>
        <Feedback tone="info"><strong>|x − a| ≤ r</strong> ⇔ x ∈ [a − r ; a + r] ; strict ⇔ ouvert ; centre = milieu, rayon = demi-longueur.</Feedback>
      </div>
    </div>
  );
}
