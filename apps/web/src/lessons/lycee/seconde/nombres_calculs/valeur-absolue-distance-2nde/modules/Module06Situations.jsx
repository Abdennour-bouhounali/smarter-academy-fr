...
/**
 * Module 6 — PRACTICE LAB : « Situations ». La manipulation s'efface : des
...
export default function Module06Situations() {
  ...
  return (
    <ContentModule
      ...
      footer={<Feedback tone="ok">Tolérance, plage, position approchée : à chaque fois un centre, un rayon, un intervalle. Le boss t’attend au phare.</Feedback>}
    />
  );
}
