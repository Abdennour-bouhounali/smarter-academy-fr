...
const QUESTIONS = [
  { id: 'q1-appartient', skill: 'ensembles', points: 2, requires: ['appartient', 'ensemble-reels'], prompt: <>Laquelle de ces affirmations est vraie ?</>, options: ['−3 ∈ ℕ', '−3 ∈ ℤ', '−3 ∉ ℝ'], cols: 3, correct: 1, explain: '−3 est un entier relatif : −3 ∈ ℤ. Il n’est pas dans ℕ (entiers positifs), mais il est bien réel.' },
