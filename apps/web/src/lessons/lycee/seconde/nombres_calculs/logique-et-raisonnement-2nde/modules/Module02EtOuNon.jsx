...
export default function Module02EtOuNon() {
  ...
  return (
    <ContentModule
      ...
      footer={<Feedback tone="ok"><strong>ET</strong> exige les deux ; <strong>OU</strong> se contente d’une (et accepte les deux) ; <strong>NON</strong> couvre exactement le reste. Reste le connecteur le plus utile — et le plus piégeux : « si… alors ».</Feedback>}
    />
  );
}
