...
/**
 * Module 7 — Boss Final « Le tribunal des affirmations » (kit, QCM). DONNÉES.
...
function Synthese() {
  return (
    <div className="space-y-4">
      <div className="text-center space-y-1"><h2 className="text-xl font-space font-extrabold text-slate-900">Synthèse : le tribunal</h2><p className="text-sm text-slate-500">La formule d’Euler, figée au moment où elle tombe.</p></div>
      <div className="rounded-2xl border-2 border-slate-200 bg-white p-3 font-mono text-sm text-slate-800 space-y-1">
        <div>n = 39 → 39² + 39 + 41 = {39 * 39 + 39 + 41} <span className="text-emerald-700 font-bold">premier ✓</span></div>
        <div>n = 40 → 40² + 40 + 41 = {euler(40)} = <span className="text-rose-700 font-bold">{F40.a} × {F40.b} ✗</span></div>
        <div className="text-slate-600">Quarante succès, un échec : l’affirmation universelle est fausse.</div>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
        <Feedback tone="info"><strong>Proposition.</strong> Vraie ou fausse. « Pour tout » se réfute par un contre-exemple ; « il existe » se prouve par un exemple.</Feedback>
        <Feedback tone="info"><strong>Connecteurs.</strong> ET (les deux) · OU (au moins une, inclusif) · NON (le reste exactement, cas limites compris).</Feedback>
        <Feedback tone="info"><strong>Implication.</strong> Un seul cas interdit : P vraie, Q fausse. Contraposée équivalente, réciproque à tester.</Feedback>
        <Feedback tone="info"><strong>Équivalence et raisonnements.</strong> ⇔ = les deux sens. Direct, contraposée, disjonction des cas, absurde.</Feedback>
      </div>
    </div>
  );
}
