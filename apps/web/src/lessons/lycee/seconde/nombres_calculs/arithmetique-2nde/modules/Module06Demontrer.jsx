...
/**
 * Module 6 — PRACTICE LAB : « Démontrer ».
...
export default function Module06Demontrer() {
  ...
  return (
    <ContentModule
      ...
      steps={[
        { num: 1, title: 'Remets la preuve en ordre', subtitle: '« La somme de deux multiples de 7 est un multiple de 7. »', done: proofDone, content: <ProofOrder lines={PROOF} order={ORDER} onDone={() => setProofDone(true)} solved={proofDone} /> },
        {
      ...
      footer={<Feedback tone="ok">Démontrer en arithmétique : écrire l’hypothèse avec une lettre (a = 7k), transformer (7k + 7k′ = 7(k + k′)), et conclure par la DÉFINITION (« 7 × un entier, donc multiple de 7 »). Des exemples ne remplacent jamais cette chaîne.</Feedback>}
    />
  );
}
