...
export default function Module02Reduire() {
  ...
  return (
    <ContentModule
      ...
      footer={<Feedback tone="ok"><strong>Réduire :</strong> regrouper les termes de même forme (x², x, nombres) en additionnant leurs coefficients — signes compris. Les exposants ne s’additionnent pas ; la valeur ne change pas. Le tableau de valeurs reste ton détecteur d’erreur pour toute la leçon.</Feedback>}
    />
  );
}
