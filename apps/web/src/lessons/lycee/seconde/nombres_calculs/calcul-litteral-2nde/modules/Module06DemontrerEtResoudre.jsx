...
export default function Module06DemontrerEtResoudre() {
  ...
  return (
    <ContentModule
      ...
      steps={[
        { num: 1, title: 'Prouve le tour de magie', subtitle: 'Touche les lignes dans l’ordre, de l’hypothèse à la conclusion.', done: proofDone, content: <ProofOrder lines={PROOF} order={ORDER} onDone={() => setProofDone(true)} solved={proofDone} /> },
        {
      ...
      footer={<Feedback tone="ok">Démontrer, c’est écrire avec une lettre ce qui vaut pour tous les nombres, puis transformer (réduire, développer, factoriser) jusqu’à la forme qui conclut. Le boss t’attend.</Feedback>}
    />
  );
}
