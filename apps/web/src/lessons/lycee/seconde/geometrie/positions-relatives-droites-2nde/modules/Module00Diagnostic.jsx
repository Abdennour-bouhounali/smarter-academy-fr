...
const QUESTIONS = [
  {
    ...
    skill: 'equations',
    points: 2,
    requires: ['coefficient-directeur', 'ordonnee-origine', 'origine-repere'],
    prompt: 'La droite d’équation y = 3x − 2 : quel est son coefficient directeur, et son ordonnée à l’origine — celle qu’on lit sur l’axe des ordonnées, à l’origine du repère ?',
  ...
  },
  {
    ...
    skill: 'systemes',
    points: 2,
    requires: ['reduire-expression', 'terme-algebrique'],
