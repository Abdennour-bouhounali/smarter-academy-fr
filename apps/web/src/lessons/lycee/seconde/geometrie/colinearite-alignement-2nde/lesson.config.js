...
export const LESSON_CONFIG = {
  ...
  modules: [
    ...
    { id: '05', number: 5, slug: 'a-retenir', path: `${LESSON_BASE_PATH}/a-retenir`, title: 'À retenir', desc: 'Colinéaires ⇔ v = k·u ⇔ det = 0 ; alignés ; parallèles : la carte, après les gestes.', stage: 'formalization', teachesLearningPointIds: ['seconde_colinearite-alignement-2nde_P1', 'seconde_colinearite-alignement-2nde_P3', 'seconde_colinearite-alignement-2nde_P4', 'seconde_colinearite-alignement-2nde_P5', 'seconde_colinearite-alignement-2nde_P6', 'seconde_colinearite-alignement-2nde_P7'], color: 'violet', style: 'featured', estimatedMin: 6, difficulty: 3, actionText: 'Retenir' },
    { id: '06', number: 6, slug: 'alignement-et-parallelisme', path: `${LESSON_BASE_PATH}/alignement-et-parallelisme`, title: 'Alignement et parallélisme', desc: 'Trois points, un quadrilatère, une coordonnée manquante : le déterminant tranche là où l’œil hésite.', stage: 'practice_lab', teachesLearningPointIds: ['seconde_colinearite-alignement-2nde_P6', 'seconde_colinearite-alignement-2nde_P7', 'seconde_colinearite-alignement-2nde_P8', 'seconde_colinearite-alignement-2nde_P9'], color: 'rose', style: 'featured', estimatedMin: 10, difficulty: 4, actionText: 'Résoudre' },
    { id: '07', number: 7, slug: 'mission-finale-le-detecteur', path: `${LESSON_BASE_PATH}/mission-finale-le-detecteur`, title: '🏆 Mission finale : le détecteur', desc: 'Dix épreuves pour prouver qu’aucun alignement ne t’échappe.', stage: 'evaluation', color: 'amber', style: 'assessment', estimatedMin: 13, difficulty: 4, actionText: 'Relever le défi' },
  ],
};
