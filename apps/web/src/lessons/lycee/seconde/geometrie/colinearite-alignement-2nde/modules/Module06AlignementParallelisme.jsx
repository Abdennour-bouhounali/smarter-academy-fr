...
/**
 * Module 6 — PRACTICE LAB : « Alignement et parallélisme ».
 *
...
export default function Module06AlignementParallelisme() {
  ...
  return (
    <ContentModule
      ...
      steps={[
        {
          num: 1, title: 'Deux droites parallèles', subtitle: 'A, B, C sont fixes. Déplace D : trouve deux positions où (CD) ∥ (AB), dont une avec CD de sens contraire à AB.', done: done1,
          content: (kit) => (
      ...
      footer={<Feedback tone="ok">Cinq niveaux, une seule idée : quand l’œil hésite, on construit deux vecteurs et on calcule leur déterminant. Zéro, alignés (ou parallèles) ; sinon, non. À prouver dix fois dans la mission finale.</Feedback>}
    />
  );
}
