...
export const LESSON_CONFIG = {
  ...
  modules: [
    { id: '00', number: 0, slug: 'mission-de-depart', path: `${LESSON_BASE_PATH}/mission-de-depart`, title: 'Mission de départ', desc: 'Ce que le triangle rectangle t\'a déjà appris.', stage: 'prerequisite_check', color: 'slate', style: 'compact', estimatedMin: 5, difficulty: 1, actionText: 'Commencer' },
