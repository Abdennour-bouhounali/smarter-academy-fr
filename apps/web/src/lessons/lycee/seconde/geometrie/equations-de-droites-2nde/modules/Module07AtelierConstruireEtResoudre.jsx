...
export default function Module07AtelierConstruireEtResoudre() {
  ...
  return (
    <ContentModule
      ...
      footer={<Feedback tone="ok">Deux points, un point et une flèche, un point et une pente, une équation à lire, une droite à tracer, une rampe à vérifier : tu sais tout faire. À prouver dix fois dans la mission finale.</Feedback>}
    />
  );
}
