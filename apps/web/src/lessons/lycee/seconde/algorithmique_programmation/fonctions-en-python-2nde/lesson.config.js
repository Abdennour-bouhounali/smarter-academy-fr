...
export const LESSON_CONFIG = {
  ...
  modules: [
    ...
    { id: '07', number: 7, slug: 'mission-finale-la-fonction', path: `${LESSON_BASE_PATH}/mission-finale-la-fonction`, title: '🏆 Mission finale : la fonction', desc: 'Treize épreuves : définir, appeler, portée, lire, simuler, vérifier.', stage: 'evaluation', color: 'rose', style: 'featured', estimatedMin: 12, difficulty: 4, actionText: 'Relever le défi' },
  ],
};
