...
const QUESTIONS = [
  { id: 'sg-d1', skill: 'fonctions', points: 2, prompt: 'f(x) = x² − 5. Que vaut f(2) ?', options: ['−1', '−3', '9'], cols: 3, correct: 0, explain: '2² − 5 = 4 − 5 = −1.' },
  { id: 'sg-d2', skill: 'fonctions', points: 2, prompt: 'Sur une courbe, le point d’abscisse 2 a pour ordonnée −1. Ce point est…', options: ['en dessous de l’axe des abscisses', 'au-dessus de l’axe des abscisses', 'sur l’axe des ordonnées'], cols: 1, correct: 0, explain: 'Une ordonnée négative place le point sous l’axe horizontal.' },
  { id: 'sg-d3', skill: 'inegalites', points: 2, prompt: 'Résous 2x − 6 > 0.', options: ['x > 3', 'x < 3', 'x > −3'], cols: 3, correct: 0, explain: '2x > 6, donc x > 3.' },
  { id: 'sg-d4', skill: 'litteral', points: 2, prompt: 'Le produit (−3) × (−2) est…', options: ['positif : 6', 'négatif : −6', 'nul'], cols: 3, correct: 0, explain: 'Deux facteurs de même signe : produit positif.' },
  { id: 'sg-d5', skill: 'litteral', points: 2, prompt: 'Pour quelle valeur de x a-t-on x − 4 = 0 ?', options: ['4', '−4', '0'], cols: 3, correct: 0, explain: 'x − 4 = 0 ⟺ x = 4.' },
