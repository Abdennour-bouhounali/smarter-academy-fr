...
// (copié-adapté de fonctions-de-reference-2nde/components/TwoProbes.jsx le 2026-09-06 — §6ter.6)
import CoordPlane from '../../../../../common/components/CoordPlane';
import { curvePieces, imageOf, formatDec, compareImages } from './variationsUtils';
...
export default function TwoProbes({ f, range, unit = 34, unitY = null, xStep = 1, yStep = 1, labelEvery = null, a, b, onChange, step = 0.5, min, max, showMirror = false, showB = true, disabled = false, extraCurves = [], highlightIntervals = [] }) {
  ...
  return (
    <div className="space-y-3">
      <CoordPlane range={range} unit={unit} unitY={unitY} xStep={xStep} yStep={yStep} labelEvery={labelEvery} points={points} segments={segs} curves={curves} highlightIntervals={highlightIntervals} caption={false}
