  ...
  const steps = [
    {
      ...
      content: (kit) => (
        <div className="space-y-3">
          <TwoProbes {...PLANE} a={a1} b={0} showB={false} step={0.25} onChange={(v) => move1(v, kit.react)} disabled={done1} />
          {done1 ? (
    ...
    },
    {
      ...
      content: (kit) => (
        <div className="space-y-3">
          <TwoProbes {...PLANE} a={a2} b={0} showB={false} showMirror step={0.5} onChange={(v) => move2(v, kit.react)} disabled={done2 || !done1} />
          {done2 ? (
    ...
    },
    {
      ...
      content: (kit) => (
        <div className="space-y-3">
          ...
          <TwoProbes {...PLANE} a={done3 ? snap3.a : ab.a} b={done3 ? snap3.b : ab.b} step={0.5} onChange={(v) => move3(v, kit.react)} disabled={done3 || !done2} />
          {done3 ? (
            <Feedback tone="ok">
