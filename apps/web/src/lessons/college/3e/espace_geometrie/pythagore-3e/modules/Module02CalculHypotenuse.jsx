...
import { validateNumericAnswer, isMissingSquareRoot, computeHypotenuse } from '@smarter-academy/core';
...
export default function Module02CalculHypotenuse() {
  ...
  const validateAnswer = (val) => validateNumericAnswer(val, hypotenuse);
