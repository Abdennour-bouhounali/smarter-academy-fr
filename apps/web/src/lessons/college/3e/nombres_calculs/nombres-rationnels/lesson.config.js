...
export const LESSON_CONFIG = {
  ...
  modules: [
    ...
    },
    {
      ...
      color: 'indigo', style: 'featured', estimatedMin: 9, difficulty: 1, actionText: 'Re-découper la barre',
    },
    {
    ...
    },
    {
      ...
      color: 'violet', style: 'featured', estimatedMin: 12, difficulty: 3, actionText: 'Recouper les barres',
    },
    {
      ...
      color: 'emerald', style: 'featured', estimatedMin: 11, difficulty: 3, actionText: 'Peindre la grille',
    },
    {
      ...
      color: 'blue', style: 'featured', estimatedMin: 10, difficulty: 3, actionText: 'Choisir l’étape',
    },
    {
      ...
      color: 'rose', style: 'featured', estimatedMin: 11, difficulty: 3, actionText: 'Ouvrir le budget',
    },
    {
