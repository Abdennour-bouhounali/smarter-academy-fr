...
const MODULE_COMPONENTS = {
  ...
  1: lazy(() => import('./modules/Module01TroisFormules.jsx')),
  2: lazy(() => import('./modules/Module02TermesFacteurs.jsx')),
  3: lazy(() => import('./modules/Module03Reduire.jsx')),
  4: lazy(() => import('./modules/Module04RectangleAire.jsx')),
  5: lazy(() => import('./modules/Module05CarreAPlusB.jsx')),
  6: lazy(() => import('./modules/Module06Factoriser.jsx')),
  7: lazy(() => import('./modules/Module07ChoisirLaForme.jsx')),
  ...
  return (
    <Suspense fallback={<div className="min-h-screen bg-slate-50" />}>
      <LessonKnowledgeProvider
        ...
        printTitle="CALCUL LITTÉRAL ET ALGÉBRIQUE"
