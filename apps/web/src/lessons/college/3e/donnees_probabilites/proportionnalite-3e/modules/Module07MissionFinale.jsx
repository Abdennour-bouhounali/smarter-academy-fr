...
const EPREUVES = [
  {
    id: 'pr-e1', skill: 'reconnaitre', title: 'Épreuve 1',
  ...
  {
    id: 'pr-e2', skill: 'multiplicatif', title: 'Épreuve 2',
  ...
  {
    id: 'pr-e3', skill: 'multiplicatif', title: 'Épreuve 3',
  ...
  {
    id: 'pr-e4', skill: 'reconnaitre', title: 'Épreuve 4',
    prompt: 'Un tableau donne 100 km → 6,5 L et 250 km → 16,25 L. Quel est le coefficient de proportionnalité (essence en fonction de la distance) ?',
  ...
  {
    id: 'pr-e5', skill: 'chemins', title: 'Épreuve 5',
  ...
  {
    id: 'pr-e6', skill: 'chemins', title: 'Épreuve 6',
  ...
  {
    id: 'pr-e7', skill: 'pourcentages', title: 'Épreuve 7',
  ...
  {
    id: 'pr-e8', skill: 'geometrie', title: 'Épreuve 8',
  ...
  {
    id: 'pr-e9', skill: 'sciences', title: 'Épreuve 9',
    ...
    cols: 2, correct: 0,
    explain: 'Le coefficient se lit en divisant : 180 ÷ 2 = 90 km/h — la distance parcourue en une heure, c’est la pente de la droite.',
    assessment: { enabled: true, type: 'assessment', learningPointIds: ['3e_proportionnalite-3e_P10', '3e_proportionnalite-3e_P11'] },
  },
  {
    id: 'pr-e10', skill: 'sciences', title: 'Épreuve 10',
