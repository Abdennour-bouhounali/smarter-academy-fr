 ...
 * Formalization: l'invariant est nommé à l'étape 4, après avoir été constaté.
...
export default function Module03DroiteAPivot() {
  ...
  return (
    <ContentModule
      ...
      steps={[
        {
          ...
          content: (
            <TapQuestion
              ...
              correct={0}
              cols={1}
              explain="Elle tourne. Comme f(0) = a × 0 = 0 quel que soit a, le point (0 ; 0) appartient toujours à la droite : c’est un pivot."
          ...
          content: (kit) => (
            <div className="space-y-3">
              ...
              <Feedback tone={done3 ? 'ok' : 'info'}>
                {done3 ? (
                  <>
                    Tu as vu les trois régimes. Dans tous les cas, la droite est passée par{' '}
        ...
        },
        {
          ...
          content: (
            <TapQuestion
              ...
              explainWrong="Une droite quelconque ne passe pas par l’origine — celle de f(x) = 2x + 3 la rate. C’est l’absence de terme constant qui l’impose ici."
              solved={originDone}
        ...
        },
        {
          ...
          subtitle: 'L’escalier avance de 1 : de combien monte-t-il ?',
          done: readDone,
          content: (kit) => (
            <div className="space-y-3">
              <CoordPlane
              ...
              />
              <TapQuestion
                prompt="Quel est le coefficient de cette droite ?"
                options={['1,5', '2', '3', '0,5']}
                correct={0}
                cols={2}
      ...
      footer={
        <Feedback tone="info">
          <strong>À retenir.</strong> La représentation graphique de{' '}
          <MathText>{'$f(x) = ax$'}</MathText> est une <strong>droite passant par
          l’origine</strong>. Le coefficient <MathText>{'$a$'}</MathText> donne son
          inclinaison : positif elle monte, négatif elle descend.
        </Feedback>
      }
    />
  );
