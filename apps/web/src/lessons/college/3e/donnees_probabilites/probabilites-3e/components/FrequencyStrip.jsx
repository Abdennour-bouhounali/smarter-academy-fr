...
import { FACES, totalOf, frequencies, pct, spreadPoints } from './probaUtils';
 ...
 *
 * SÉCURITÉ D'AFFICHAGE : échelle commune = plus grand pourcentage (plancher
 * 40 %) ; seuls textes du SVG : six numéros de face, un par colonne.
 */
