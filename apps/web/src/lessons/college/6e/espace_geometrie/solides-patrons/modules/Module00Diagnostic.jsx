...
const QUESTIONS = [
  ...
  },
  {
    ...
    cols: 3,
    correct: 1,
    explain: 'Un rectangle est un quadrilatère : il a 4 côtés et 4 sommets.',
  },
  {
    id: 'q3-triangle',
    skill: 'figures',
    ...
    options: ['Un triangle', 'Un quadrilatère', 'Un pentagone'],
    cols: 3,
    correct: 0,
    explain: '3 côtés ⇒ un triangle. 4 ⇒ un quadrilatère, 5 ⇒ un pentagone.',
  },
  {
    id: 'q4-perimetre',
    skill: 'longueurs',
    ...
    cols: 3,
    correct: 1,
    explain: 'Le périmètre est la somme des côtés : 5 × 4 = 20 cm. (25 cm² serait l’aire.)',
  },
  {
    id: 'q5-unites',
    skill: 'longueurs',
