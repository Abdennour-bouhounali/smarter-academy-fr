...
const MODULE_COMPONENTS = {
  ...
  2: lazy(() => import('./modules/Module02DecouperUnite.jsx')),
  3: lazy(() => import('./modules/Module03FractionsDecimales.jsx')),
  4: lazy(() => import('./modules/Module04EcritureVirgule.jsx')),
  5: lazy(() => import('./modules/Module05ValeurPosition.jsx')),
  6: lazy(() => import('./modules/Module06EcrituresEquivalentes.jsx')),
  7: lazy(() => import('./modules/Module07ComparerRanger.jsx')),
  8: lazy(() => import('./modules/Module08DroiteGraduee.jsx')),
  9: lazy(() => import('./modules/Module09OrdreGrandeur.jsx')),
