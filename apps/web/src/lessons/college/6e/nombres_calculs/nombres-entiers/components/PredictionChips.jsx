 ...
 * §6ter.3) : c'est la manipulation qui répondra, pas le texte. Le retour de
 * fin d'étape cite la prédiction (« Ta prédiction : … »).
 *
 * Copié (non importé — une leçon n'importe jamais dans une autre) de
 * lycee/seconde/geometrie/colinearite-alignement-2nde/components/PredictionChips.jsx.
 *
