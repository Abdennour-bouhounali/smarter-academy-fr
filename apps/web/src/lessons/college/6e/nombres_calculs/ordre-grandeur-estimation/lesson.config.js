...
export const LESSON_CONFIG = {
  ...
  modules: [
    {
      id: 'L01-oge', number: 1, slug: 'resultat-impossible', path: `${LESSON_BASE_PATH}/resultat-impossible`,
    ...
    {
      id: 'L02-oge', number: 2, slug: 'estimer-avant-de-calculer', path: `${LESSON_BASE_PATH}/estimer-avant-de-calculer`,
    ...
    {
      id: 'L03-oge', number: 3, slug: 'arrondir-pour-estimer', path: `${LESSON_BASE_PATH}/arrondir-pour-estimer`,
    ...
    {
      id: 'L04-oge', number: 4, slug: 'ordre-de-grandeur-somme', path: `${LESSON_BASE_PATH}/ordre-de-grandeur-somme`,
    ...
    {
      id: 'L05-oge', number: 5, slug: 'ordre-de-grandeur-difference', path: `${LESSON_BASE_PATH}/ordre-de-grandeur-difference`,
    ...
    {
      id: 'L06-oge', number: 6, slug: 'ordre-de-grandeur-produit', path: `${LESSON_BASE_PATH}/ordre-de-grandeur-produit`,
    ...
    {
      id: 'L07-oge', number: 7, slug: 'detective-des-erreurs', path: `${LESSON_BASE_PATH}/detective-des-erreurs`,
    ...
    {
      id: 'L08-oge', number: 8, slug: 'estimation-dans-des-problemes', path: `${LESSON_BASE_PATH}/estimation-dans-des-problemes`,
    ...
    {
      id: 'L09-oge', number: 9, slug: 'choisir-le-niveau-de-precision', path: `${LESSON_BASE_PATH}/choisir-le-niveau-de-precision`,
    ...
    {
      id: 'L10-oge', number: 10, slug: 'detective-des-resultats', path: `${LESSON_BASE_PATH}/detective-des-resultats`,
