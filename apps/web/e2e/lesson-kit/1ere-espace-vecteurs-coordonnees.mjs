...
const BASE = process.env.KIT_BASE || 'http://localhost:5292';
const LESSON = '/courses/lycee/premiere_specialite/geometrie/espace-vecteurs-coordonnees-1ere';
const KEY = 'u_anon_smarter_lesson_espace-vecteurs-coordonnees-1ere';

const M = {
  0: `${BASE}/courses/lycee/premiere_specialite/geometrie/espace-vecteurs-coordonnees-1ere/mission-de-depart`,
  1: `${BASE}/courses/lycee/premiere_specialite/geometrie/espace-vecteurs-coordonnees-1ere/la-boite-et-les-trois-nombres`,
  2: `${BASE}/courses/lycee/premiere_specialite/geometrie/espace-vecteurs-coordonnees-1ere/la-troisieme-coordonnee`,
  3: `${BASE}/courses/lycee/premiere_specialite/geometrie/espace-vecteurs-coordonnees-1ere/pythagore-deux-fois`,
  4: `${BASE}/courses/lycee/premiere_specialite/geometrie/espace-vecteurs-coordonnees-1ere/un-terme-de-plus`,
  5: `${BASE}/courses/lycee/premiere_specialite/geometrie/espace-vecteurs-coordonnees-1ere/les-droites-paralleles`,
  6: `${BASE}/courses/lycee/premiere_specialite/geometrie/espace-vecteurs-coordonnees-1ere/orthogonales-sans-se-couper`,
  7: `${BASE}/courses/lycee/premiere_specialite/geometrie/espace-vecteurs-coordonnees-1ere/mission-finale-la-boite`,
};

/** Apports de chaque module à la carte — miroir de knowledge.jsx. */
const CONTRIB = {
  1: ['trois-deplacements', 'deux-triangles-rectangles'],
  2: ['repere-espace', 'coordonnees-vecteur-espace', 'mem-arrivee-moins-depart-espace'],
  3: ['formule-norme-espace', 'methode-calculer-norme-espace', 'mem-trois-carres'],
  4: ['formule-scalaire-espace', 'mem-un-terme-de-plus'],
  5: ['droites-espace-trois-cas', 'regle-parallelisme-espace', 'methode-trancher-parallelisme'],
  6: ['regle-orthogonalite-espace', 'mem-nul-ne-veut-pas-dire-secantes'],
};
...
// ── Index ────────────────────────────────────────────────────────────────
{
  ...
  await page.screenshot({ path: `${SHOT_DIR}espace-vecteurs-coordonnees-1ere-index.png`, fullPage: true });
  await ctx.close();
}
...
// ── Modules d'enseignement : manipulables, non gelés, mise en page saine ──
{
  ...
  await page.screenshot({ path: `${SHOT_DIR}espace-vecteurs-coordonnees-1ere-m1.png`, fullPage: true });
  await ctx.close();
}
{
  ...
  await page.screenshot({ path: `${SHOT_DIR}espace-vecteurs-coordonnees-1ere-m2.png`, fullPage: true });
  await ctx.close();
}
{
  ...
  await page.screenshot({ path: `${SHOT_DIR}espace-vecteurs-coordonnees-1ere-m3.png`, fullPage: true });
  await ctx.close();
}
{
  ...
  await page.screenshot({ path: `${SHOT_DIR}espace-vecteurs-coordonnees-1ere-m4.png`, fullPage: true });
  await ctx.close();
}
{
  ...
  await page.screenshot({ path: `${SHOT_DIR}espace-vecteurs-coordonnees-1ere-m5.png`, fullPage: true });
  await ctx.close();
}
{
  ...
  await page.screenshot({ path: `${SHOT_DIR}espace-vecteurs-coordonnees-1ere-m6.png`, fullPage: true });
  await ctx.close();
}
...
// ── Le boss ──────────────────────────────────────────────────────────────
{
  ...
  await page.screenshot({ path: `${SHOT_DIR}espace-vecteurs-coordonnees-1ere-boss.png`, fullPage: true });
  await ctx.close();
}
...
for (const n of [1, 7]) {
  ...
  if (n === 1) await page.screenshot({ path: `${SHOT_DIR}espace-vecteurs-coordonnees-1ere-m1-mobile.png`, fullPage: true });
  await ctx.close();
}
