...
const BASE = process.env.KIT_BASE || 'http://localhost:5294';
const LESSON = '/courses/lycee/premiere_specialite/analyse/exponentielle-decouvrir-1ere';
const KEY = 'u_anon_smarter_lesson_exponentielle-decouvrir-1ere';

const M = {
  0: `${BASE}/courses/lycee/premiere_specialite/analyse/exponentielle-decouvrir-1ere/mission-de-depart`,
  1: `${BASE}/courses/lycee/premiere_specialite/analyse/exponentielle-decouvrir-1ere/la-courbe-qui-construit-sa-pente`,
  2: `${BASE}/courses/lycee/premiere_specialite/analyse/exponentielle-decouvrir-1ere/une-seule-courbe-possible`,
  3: `${BASE}/courses/lycee/premiere_specialite/analyse/exponentielle-decouvrir-1ere/jamais-zero`,
  4: `${BASE}/courses/lycee/premiere_specialite/analyse/exponentielle-decouvrir-1ere/toujours-en-montee`,
  5: `${BASE}/courses/lycee/premiere_specialite/analyse/exponentielle-decouvrir-1ere/la-courbe-et-sa-tangente`,
  6: `${BASE}/courses/lycee/premiere_specialite/analyse/exponentielle-decouvrir-1ere/deriver-exp-de-u`,
  7: `${BASE}/courses/lycee/premiere_specialite/analyse/exponentielle-decouvrir-1ere/mission-finale-l-exponentielle`,
};

/** Apports de chaque module à la carte — miroir de knowledge.jsx. */
const CONTRIB = {
  2: ['propriete-caracteristique', 'exponentielle-definition', 'mem-exp-egale-sa-derivee'],
  3: ['exp-definie-sur-r', 'exp-strictement-positive', 'mem-exp-jamais-nulle'],
  4: ['exp-strictement-croissante'],
  5: ['tangente-en-zero', 'exp-comportement-aux-bornes'],
  6: ['regle-derivee-exp-u', 'mem-facteur-descend'],
};
...
// ── Index ────────────────────────────────────────────────────────────────
{
  ...
  await page.screenshot({ path: `${SHOT_DIR}exponentielle-decouvrir-1ere-index.png`, fullPage: true });
  await ctx.close();
}
...
// ── Modules d'enseignement : manipulables, non gelés, mise en page saine ──
{
  ...
  await page.screenshot({ path: `${SHOT_DIR}exponentielle-decouvrir-1ere-m1.png`, fullPage: true });
  await ctx.close();
}
{
  ...
  await page.screenshot({ path: `${SHOT_DIR}exponentielle-decouvrir-1ere-m2.png`, fullPage: true });
  await ctx.close();
}
{
  ...
  await page.screenshot({ path: `${SHOT_DIR}exponentielle-decouvrir-1ere-m3.png`, fullPage: true });
  await ctx.close();
}
{
  ...
  await page.screenshot({ path: `${SHOT_DIR}exponentielle-decouvrir-1ere-m4.png`, fullPage: true });
  await ctx.close();
}
{
  ...
  await page.screenshot({ path: `${SHOT_DIR}exponentielle-decouvrir-1ere-m5.png`, fullPage: true });
  await ctx.close();
}
{
  ...
  await page.screenshot({ path: `${SHOT_DIR}exponentielle-decouvrir-1ere-m6.png`, fullPage: true });
  await ctx.close();
}
...
// ── Le boss ──────────────────────────────────────────────────────────────
{
  ...
  await page.screenshot({ path: `${SHOT_DIR}exponentielle-decouvrir-1ere-boss.png`, fullPage: true });
  await ctx.close();
}
...
for (const n of [1, 7]) {
  ...
  if (n === 1) await page.screenshot({ path: `${SHOT_DIR}exponentielle-decouvrir-1ere-m1-mobile.png`, fullPage: true });
  await ctx.close();
}
