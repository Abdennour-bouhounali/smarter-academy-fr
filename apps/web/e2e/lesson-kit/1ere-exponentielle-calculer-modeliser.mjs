/**
 * 1ère spé — « Exponentielle : règles de calcul et modèles ».
 *
 ...
 *   node apps/web/e2e/lesson-kit/1ere-exponentielle-calculer-modeliser.mjs
 *
...
const LESSON = '/courses/lycee/premiere_specialite/analyse/exponentielle-calculer-modeliser-1ere';
const KEY = 'u_anon_smarter_lesson_exponentielle-calculer-modeliser-1ere';

const M = {
  0: `${BASE}/courses/lycee/premiere_specialite/analyse/exponentielle-calculer-modeliser-1ere/mission-de-depart`,
  1: `${BASE}/courses/lycee/premiere_specialite/analyse/exponentielle-calculer-modeliser-1ere/la-somme-devient-un-produit`,
  2: `${BASE}/courses/lycee/premiere_specialite/analyse/exponentielle-calculer-modeliser-1ere/la-regle-fondamentale`,
  3: `${BASE}/courses/lycee/premiere_specialite/analyse/exponentielle-calculer-modeliser-1ere/l-oppose-et-la-difference`,
  4: `${BASE}/courses/lycee/premiere_specialite/analyse/exponentielle-calculer-modeliser-1ere/la-puissance`,
  5: `${BASE}/courses/lycee/premiere_specialite/analyse/exponentielle-calculer-modeliser-1ere/resoudre-une-equation`,
  6: `${BASE}/courses/lycee/premiere_specialite/analyse/exponentielle-calculer-modeliser-1ere/inegalites-et-modeles`,
  7: `${BASE}/courses/lycee/premiere_specialite/analyse/exponentielle-calculer-modeliser-1ere/mission-finale-le-traducteur`,
};

/** Apports de chaque module à la carte — miroir de knowledge.jsx. */
const CONTRIB = {
  2: ['relation-fondamentale-exp', 'mem-somme-devient-produit'],
  3: ['exp-oppose-inverse', 'exp-difference-quotient', 'mem-oppose-et-difference'],
  4: ['exp-puissance', 'mem-puissance-multiplie'],
  5: ['egalite-des-exposants', 'methode-resoudre-equation-exp'],
  6: ['inegalite-sens-conserve', 'modele-exponentiel', 'facteur-constant'],
};
...
// ── Index ────────────────────────────────────────────────────────────────
{
  ...
  await page.screenshot({ path: `${SHOT_DIR}exponentielle-calculer-modeliser-1ere-index.png`, fullPage: true });
  await ctx.close();
}
...
// ── Modules d'enseignement : manipulables, non gelés, mise en page saine ──
{
  ...
  await page.screenshot({ path: `${SHOT_DIR}exponentielle-calculer-modeliser-1ere-m1.png`, fullPage: true });
  await ctx.close();
}
{
  ...
  await page.screenshot({ path: `${SHOT_DIR}exponentielle-calculer-modeliser-1ere-m2.png`, fullPage: true });
  await ctx.close();
}
{
  ...
  await page.screenshot({ path: `${SHOT_DIR}exponentielle-calculer-modeliser-1ere-m3.png`, fullPage: true });
  await ctx.close();
}
{
  ...
  await page.screenshot({ path: `${SHOT_DIR}exponentielle-calculer-modeliser-1ere-m4.png`, fullPage: true });
  await ctx.close();
}
{
  ...
  await page.screenshot({ path: `${SHOT_DIR}exponentielle-calculer-modeliser-1ere-m5.png`, fullPage: true });
  await ctx.close();
}
{
  ...
  await page.screenshot({ path: `${SHOT_DIR}exponentielle-calculer-modeliser-1ere-m6.png`, fullPage: true });
  await ctx.close();
}
...
// ── Le boss ──────────────────────────────────────────────────────────────
{
  ...
  await page.screenshot({ path: `${SHOT_DIR}exponentielle-calculer-modeliser-1ere-boss.png`, fullPage: true });
  await ctx.close();
}
...
for (const n of [1, 7]) {
  ...
  if (n === 1) await page.screenshot({ path: `${SHOT_DIR}exponentielle-calculer-modeliser-1ere-m1-mobile.png`, fullPage: true });
  await ctx.close();
}
