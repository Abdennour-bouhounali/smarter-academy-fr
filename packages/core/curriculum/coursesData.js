...
const smaMetadata = {
  ...
  '4e_calcul_litteral': {
    ...
    description: "Transformer les expressions littérales : réduire, développer avec la distributivité simple puis double, factoriser un facteur commun évident, tester une égalité, et résoudre une équation du premier degré en comprenant ce qu'on cherche.",
  ...
  '4e_triangles': {
    id: 'triangles-4e',
    description: "Démontrer dans le triangle : découvrir le théorème de Pythagore par les aires, l'utiliser pour calculer une longueur, décider avec sa réciproque si un triangle est rectangle, puis rencontrer le cercle circonscrit au triangle rectangle et la droite des milieux.",
