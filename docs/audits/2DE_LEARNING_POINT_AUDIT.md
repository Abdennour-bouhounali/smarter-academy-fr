...
> Audit du 2026-09-09. Périmètre : les 29 leçons de Seconde du catalogue
> (27 construites, 2 au catalogue seulement), leurs 249 learning points, et la
> réconciliation avec une liste externe de 159 points fournie pour la mission.
>
...
5. Seulement ensuite, **générer** : les deux leçons d'algorithmique d'abord (§10).
<!-- END SECTION: next -->
