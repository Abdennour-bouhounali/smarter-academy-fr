    ...
    >
      <section className="bg-white rounded-3xl border border-slate-200 shadow-sm p-6 space-y-6">
        ...
        <p className="text-slate-700 leading-relaxed mb-4">
          Vous savez résoudre <span className="font-mono bg-slate-100 px-1 rounded">A × B = 0</span>. 
          Mais que faire face à <span className="font-mono bg-rose-100 px-1 rounded text-rose-800">x² + 5x = 0</span> ?
              ...
              <div className="mt-8 animate-in slide-in-from-top-4 flex flex-col items-center">
                ...
                {step === 1 && (
                  <div className="mt-4 text-sky-600 font-bold flex items-center gap-2 animate-pulse">
                    <MousePointerClick size={18} /> Cliquez sur le "x" commun
                  </div>
                )}
            ...
            {step >= 3 && (
              <div className="mt-8 animate-in slide-in-from-top-8 flex flex-col items-center">
                ...
                <div className="text-5xl font-mono font-black flex items-center gap-2">
                  <span className="text-sky-600 bg-sky-100 px-3 py-1 rounded-xl">x</span>
                  <span className="text-slate-800">( x + 5 )</span>
                </div>
                ...
                {step === 4 && (
                  <div className="mt-4 px-4 py-2 bg-emerald-100 text-emerald-800 font-bold rounded-lg text-sm flex items-center gap-2 animate-in zoom-in">
                    <CheckCircle2 size={16} /> x × x + x × 5 = x² + 5x (C'est bon !)
                  </div>
                )}
              </div>
            )}
      ...
      {showErrorBox && (
        <section className="bg-white rounded-3xl border border-slate-200 shadow-sm p-6 space-y-6 animate-in slide-in-from-bottom-8">
          ...
          <p className="text-slate-700 mb-4">
            Maintenant que l'équation <span className="font-mono text-slate-500">x² + 5x = 0</span> est transformée en un produit <span className="font-mono bg-emerald-50 text-emerald-800 px-1 rounded font-bold">x(x + 5) = 0</span>, on peut utiliser la règle du zéro !
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-emerald-50 border-2 border-emerald-200 rounded-xl p-6 text-center">
               <h4 className="font-bold text-emerald-800 mb-4 uppercase tracking-wide text-sm">Le Facteur n°1</h4>
               <div className="text-3xl font-mono font-bold text-emerald-700 mb-2">x = 0</div>
            </div>
            
            <div className="bg-emerald-50 border-2 border-emerald-200 rounded-xl p-6 text-center">
               <h4 className="font-bold text-emerald-800 mb-4 uppercase tracking-wide text-sm">Le Facteur n°2</h4>
               <div className="text-xl font-mono font-bold text-emerald-600 mb-2">x + 5 = 0</div>
               <div className="text-3xl font-mono font-bold text-emerald-700">x = -5</div>
            </div>
          </div>
          ...
          <div className="bg-rose-50 p-6 rounded-2xl border border-rose-100 mt-6">
            ...
            <div className="flex flex-col md:flex-row items-center gap-4 text-slate-700">
              <div className="flex-1">
                Certains élèves factorisent mal et écrivent <span className="font-mono text-rose-600 font-bold">x(x + 5) = x² + 5</span>. 
                <br/>C'est <strong>FAUX</strong> car le "x" se distribue sur le "x" ET sur le "5". <br/>
              ...
              <div className="font-mono text-lg bg-white p-4 rounded-xl border border-rose-200 text-center">
                <span className="text-blue-600">x</span>(<span className="text-emerald-600">x</span> + <span className="text-emerald-600">5</span>) <br/>
                = <span className="text-blue-600">x</span>×<span className="text-emerald-600">x</span> + <span className="text-blue-600">x</span>×<span className="text-emerald-600">5</span>
              </div>
            </div>
          </div>
        </section>
